...
int main(int argc, char **argv)
{
  ...
  ROS_INFO_NAMED("tutorial", "Visualizing plan 1 (pose goal) %s", success == moveit_msgs::MoveItErrorCodes::SUCCESS ? "" : "FAILED");
  ...
  ROS_INFO_NAMED("tutorial", "Visualizing plan 2 (joint space goal) %s", success == moveit_msgs::MoveItErrorCodes::SUCCESS ? "" : "FAILED");
