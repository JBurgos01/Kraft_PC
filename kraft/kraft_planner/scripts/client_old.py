...
class LabviewServer:
	def __init__(self):	
		...
		self.force_pub = rospy.Publisher("/phantom/force_feedback", OmniFeedback, queue_size=100)
	...
	def send_message(self):
		...
		# Envio info de bloqueo (force_lock True o False)
		force_msg = OmniFeedback()
		force_msg.position.x = xpos
		force_msg.position.y = ypos
		force_msg.position.z = zpos
		force_msg.lock = force_lock
		try:
